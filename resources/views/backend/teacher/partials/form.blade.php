                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input type="text" name="title" class="form-control" required
                                       value="{{ old('title', isset($teacher->title) ? $teacher->title : '') }}"/>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input type="text" name="designation" class="form-control" required
                                       value="{{ old('designation', isset($teacher->designation) ? $teacher->designation : '') }}"/>
                                ...
                                <div class="input-group">
                                    <div class="input-group-content">
                                        <input type="text" name="facebook" class="form-control"
                                               value="{{ old('facebook', isset($teacher->facebook) ? $teacher->facebook : '') }}">
                                ...
                                <div class="input-group">
                                    <div class="input-group-content">
                                        <input type="text" name="twitter" class="form-control"
                                               value="{{ old('twitter', isset($teacher->twitter) ? $teacher->twitter : '') }}">
                                        <label>Twitter</label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="input-group">
                                    <div class="input-group-content">
                                        <input type="text" name="instagram" class="form-control"
                                               value="{{ old('instagram', isset($teacher->instagram) ? $teacher->instagram : '') }}">
                                ...
                                <div class="input-group">
                                    <div class="input-group-content">
                                        <input type="text" name="linkedin" class="form-control"
                                               value="{{ old('linkedin', isset($teacher->linkedin) ? $teacher->linkedin : '') }}">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" id=""
                                          class="ckeditor">{{old('description',isset($teacher->description)?$teacher->description : '')}}</textarea>
                    ...
                    <div id="accordion1-1" class="collapse in">
                        <div class="card-actionbar">
                            <div class="card-actionbar-row">
                                <a class="btn btn-default btn-ink" href="{{ route('teacher.index') }}">
                            ...
                            <div class="side-label">
                                ...
                                <div class="label-body">
                                    <input type="checkbox" id="switch_demo_1" name="is_published"
                                           {{ old('is_published', isset($teacher->is_published) ? $teacher->is_published : '')=='1' ? 'checked':'' }} data-switchery/>
                                </div>
                            </div>
                            <div class="side-label">
                                <div class="label-head">
                                ...
                                <div class="label-body">
                                    <input type="checkbox" id="switch_demo_1" name="is_featured"
                                           {{ old('status', isset($teacher->is_featured) ? $teacher->is_featured : '')=='1' ? 'checked':'' }} data-switchery/>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            @if(isset($teacher->image))
                                @if(!empty($teacher->image))
                                    <input type="file" name="image" class="dropify"
                                           data-default-file="{{ asset($teacher->thumbnail_path) }}"/>
                                @else
                                    <input type="file" name="image" class="dropify"/>
                                @endif
                            @else
