                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        {{--                                        {{ Form::label('setting[counter_title_1]', 'Counter 1') }}--}}
                                        <div class="col-md-6">
                                            {{ Form::text('setting[counter_title_1]', old('setting.counter_title_1') ?: setting('counter_title_1'), ['class'=>'form-control','placeholder'=>'Title']) }}
                                        </div>
                                        <div class="col-md-6">
                                            {{ Form::text('setting[counter_count_1]', old('setting.counter_count_1') ?: setting('counter_count_1'), ['class'=>'form-control','placeholder'=>'Count']) }}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        {{--                                        {{ Form::label('setting[counter_title_2]', 'Counter 2') }}--}}
                                        <div class="col-md-6">
                                            {{ Form::text('setting[counter_title_2]', old('setting.counter_title_2') ?: setting('counter_title_2'), ['class'=>'form-control','placeholder'=>'Title']) }}
                                        </div>
                                        <div class="col-md-6">
                                            {{ Form::text('setting[counter_count_2]', old('setting.counter_count_2') ?: setting('counter_count_2'), ['class'=>'form-control','placeholder'=>'Count']) }}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        {{--                                        {{ Form::label('setting[counter_title_3]', 'Counter 3') }}--}}
                                        <div class="col-md-6">
                                            {{ Form::text('setting[counter_title_3]', old('setting.counter_title_3') ?: setting('counter_title_3'), ['class'=>'form-control','placeholder'=>'Title']) }}
                                        </div>
                                        <div class="col-md-6">
                                            {{ Form::text('setting[counter_count_3]', old('setting.counter_count_3') ?: setting('counter_count_3'), ['class'=>'form-control','placeholder'=>'Count']) }}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        {{--                                        {{ Form::label('setting[counter_title_4]', 'Counter 4') }}--}}
                                        <div class="col-md-6">
                                            {{ Form::text('setting[counter_title_4]', old('setting.counter_title_4') ?: setting('counter_title_4'), ['class'=>'form-control','placeholder'=>'Title']) }}
                                        </div>
                                        <div class="col-md-6">
                                            {{ Form::text('setting[counter_count_4]', old('setting.counter_count_4') ?: setting('counter_count_4'), ['class'=>'form-control','placeholder'=>'Count']) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
