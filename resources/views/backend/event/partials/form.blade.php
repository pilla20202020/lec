                            ...
                            <div class="form-group">
                                <div class="input-group" id="demo-date">
                                    <div class="input-group-content">
                                        <input type="text" name="event_date" class="form-control datetime"
                                               value="{{ old('event_date', isset($event->event_date) ? $event->event_date->format('Y-m-d h:m') : '') }}">
                    ...
                    <div id="accordion1-1" class="collapse in">
                        ...
                        <div class="card-head">
                            ...
                            <div class="side-label">
                                ...
                                <div class="label-body">
                                    <input type="checkbox" id="switch_demo_1" name="is_notice"
                                           {{ old('is_notice', isset($event->is_notice) ? $event->is_notice : '')=='1' ? 'checked':'' }} data-switchery/>
                                </div>
                            </div>
                        </div>
                    </div>
